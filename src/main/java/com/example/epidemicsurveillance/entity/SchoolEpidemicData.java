...
@ApiModel(value="SchoolEpidemicData对象", description="校园疫情数据表")
public class SchoolEpidemicData implements Serializable {
    ...
    @ApiModelProperty(value = "学校或学院名称")
    private String name;
    ...
    @ApiModelProperty(value = "疫苗接种人数")
    private Integer totalVaccines;

    @ApiModelProperty(value = "疫苗接种率")
    private BigDecimal vaccinesProportion;
